import { getAdmins, getUsers } from "./Apiconection.js";
...
async function validateLogin(e){
    ...
    const passwordUsuario = document.querySelector('#passwordUsuario').value;
    ...
    if(password===logins.passwordUsuario && user===logins.nombreUsuario){
      alert('correcto')
      window.location.href = 'index.html'
    }
    })

    admins.forEach(admines =>{
        const {user, password} = admines
